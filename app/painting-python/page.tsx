...
export default function SpectrumSnakePage() {
  ...
  }, [moveSnake, moveToNextLevel, showRules]);
    ...
    >
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          >
            Eat blocks in{' '}
            <span style={{ color: 'var(--cyan)' }}>matching color pairs</span> to grow your python.
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
            ...
            >
              ...
              next block must be the same color. Color is reset after a match is found. Success = +1 point. Mismatch =
              game over.
            </p>
